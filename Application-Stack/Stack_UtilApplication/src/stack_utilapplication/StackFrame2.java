...
public class StackFrame2 extends javax.swing.JFrame {
    ...
    public void showDatainStackA() {
        ...
        for (int i = stackA.size()-1; i >= 0; i--) {
            jTable1.setValueAt(stackA.get(i), (maxStack - i), 0);
        }
    }
    ...
    public void showDatainStackB() {
        ...
        for (int i = (stackB.size()-1); i >= 0; i--) {
            jTable2.setValueAt(stackB.get(i), (maxStack - i), 0);
        }
    }
    ...
    public void showDatainStackC() {
        ...
        for (int i = stackC.size()-1; i >= 0; i--) {
            jTable3.setValueAt(stackC.get(i), (maxStack - i), 0);
        }
    }
    ...
    public StackFrame2() {
        ...
        jTextField3.setText(String.valueOf(stackA.size() ));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if (stackB.size()> 0 || stackC.size() > 0) {
            ...
            if (stackA.size() == 0 || Integer.parseInt(jTextField1.getText()) < stackA.peek()) {
                PUSH(Integer.parseInt(jTextField1.getText()), 'A');
                jTextField3.setText(String.valueOf(stackA.size()));
                showDatainStackA();
            } else {
                JOptionPane.showMessageDialog(null, "The input number must be smaller than " + stackA.peek(), "InfoBox: " + "Warning", JOptionPane.INFORMATION_MESSAGE);
            }
            jTextField1.setText("");
        }
...
if(stackC.size()>0|| stackB.size()>0){   
