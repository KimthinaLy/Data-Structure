...
//---------------------------ArrayTrav----------------------------------
    public void ArrayTrav() {
        ...
        for (int i = 0; i < list.size(); i++) {
            DNode d = list.get(i);
            model.addRow(new Object[]{d.plateNum, d.brand, d.maxSpeed, d.cost, d.color, d.horsePow});
        }
    }
    //-----------------------Insert------------------------------------------ 

    public void insert(int k, int plateNum, String brand, int maxSpeed, double cost, String color, int horsePow) {
        if (k > list.size()) {
            list.add(list.size(), new DNode(plateNum, brand, maxSpeed, cost, color, horsePow));
        } else {
            list.add(k, new DNode(plateNum, brand, maxSpeed, cost, color, horsePow));
        }
    ...
    public void sortByPlateNum() {
        ...
        Collections.sort(list, Comparator.comparingInt(d -> d.plateNum));

    }

    public void sortByMaxSpeed() {
        
        Collections.sort(list, Comparator.comparingInt(d -> d.maxSpeed));

    }

    public void sortByCost() {
        
        Collections.sort(list, Comparator.comparingDouble(d -> d.cost));
    ...
    public LLApplication2() {
        ...
        list.add(new DNode(2058, "Ford", 261, 40000, "Red", 190));
        list.add(new DNode(4433, "Toyota", 265, 50000, "Black", 199));
        list.add(new DNode(2907, "BMW", 320, 70000, "White", 190));
        list.add(new DNode(9123, "BMW", 320, 70000, "Black", 170));
        list.add(new DNode(6978, "Mazda", 260, 50600, "Yellow", 200));
