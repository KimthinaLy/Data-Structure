 ...
 * @author Admin
 */
public class LLApplication2 extends javax.swing.JFrame {
...
//---------------------------ArrayTrav----------------------------------
    public void ArrayTrav() {
        ...
        ptr = start;
        while (ptr != null) {
            model.addRow(new Object[]{ptr.plateNum, ptr.brand, ptr.maxSpeed, ptr.cost, ptr.color, ptr.horsePow});
            ptr = ptr.FORW;
        }
    }
    //-----------------------Insert------------------------------------------ 

    public DNode searchLoc(int k) {
        DNode LOC;
        DNode ptr;
        ptr = start;
        for (int i = 1; i <= k; i++) {
    ...
    public void insert(DNode NEW, int k) {
        DNode LOC = searchLoc(k);
        if (start == null) {
            start = NEW;
            return;
        }
    ...
    //-----------------------Search------------------------
    public DNode searchCar(int plateN) {
        DNode LOC = null;
        DNode ptr;
        ptr = start;
        while (ptr != null) {
            if (ptr.plateNum == plateN) {
                LOC = ptr;
                return LOC;
            } else {
                ptr = ptr.FORW;
    ...
    public void sortByPlateNum() {
        ...
        do {
            ...
            while (ptr.FORW != last) {
                if (ptr.plateNum > ptr.FORW.plateNum) {
                    int temp = ptr.plateNum;
                    ptr.plateNum = ptr.FORW.plateNum;
                    ptr.FORW.plateNum = temp;

                    swapped = true;
                }
                ptr = ptr.FORW;
            }
            last = ptr; // Reduce the unsorted portion
        } while (swapped);
    ...
    public void sortByMaxSpeed() {
        ...
        do {
            ...
            while (ptr.FORW != last) {
                if (ptr.maxSpeed > ptr.FORW.maxSpeed) {
                    int temp = ptr.maxSpeed;
                    ptr.maxSpeed = ptr.FORW.maxSpeed;
                    ptr.FORW.maxSpeed = temp;
    ...
    public void sortByCost() {
        ...
        do {
            ...
            while (ptr.FORW != last) {
                if (ptr.cost > ptr.FORW.cost) {
                    double temp = ptr.cost;
                    ptr.cost = ptr.FORW.cost;
                    ptr.FORW.cost = temp;
     ...
     */
    public LLApplication2() {
        initComponents();
        DNode nodeA = new DNode();
        DNode nodeB = new DNode();
        DNode nodeC = new DNode();
        DNode nodeD = new DNode();
        DNode nodeE = new DNode();
        nodeA.plateNum = 2058;
        nodeA.brand = "Ford";
        nodeA.maxSpeed = 261;
        nodeA.cost = 40000;
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        DNode LOC = searchLoc(k);
        if (LOC != null) {
            jTextField3.setText(String.valueOf(LOC.plateNum));
            jTextField4.setText(String.valueOf(LOC.brand));
            jTextField5.setText(String.valueOf(LOC.cost));
            jTextField6.setText(String.valueOf(LOC.maxSpeed));
            jTextField7.setText(String.valueOf(LOC.color));
            jTextField8.setText(String.valueOf(LOC.horsePow));
            delete(k);
            ArrayTrav();
        }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        DNode result = searchCar(Integer.parseInt(jFormattedTextField7.getText()));
        if (result == null) {
            ...
            jTextField10.setText(String.valueOf(result.plateNum));
            jTextField11.setText(result.brand);
            jTextField12.setText(String.valueOf(result.maxSpeed));
            jTextField13.setText(String.valueOf(result.cost));
            jTextField14.setText(result.color);
            jTextField15.setText(String.valueOf(result.horsePow));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LLApplication2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LLApplication2().setVisible(true);
            }
        });
    }
